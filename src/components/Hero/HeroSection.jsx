        ...
        <main className="flex  justify-between items-center py-[10px] px-[20px] ">
          <section className="flex gap-4  justify-center items-center  p-[10px]">
            <div className="flex justify-center items-center flex-col gap-2">
              <div className="bg-[#fee6fb] p-[10px]  rounded-[5px]">
                <img className="w-[200px]" src={c1} alt="" />
              </div>
              <div className="bg-[#e9ffa6] p-[10px]  rounded-[5px]">
                <img className="w-[200px]" src={c2} alt="" />
              </div>
            </div>
            <div className="flex justify-center items-center flex-col gap-2">
              <div className="bg-[#c6fadd] p-[10px]  rounded-[5px]">
                <img className="w-[200px]" src={c3} alt="" />
              </div>

              <div className="bg-[#b2f2fc] p-[10px]  rounded-[5px]">
          ...
          <section
            className="w-[600px] h-[430px] bg-cover bg-center duration-1000 linear transition-all rounded-[20px]"
